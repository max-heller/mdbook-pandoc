...
- Wrap cells of wide tables ([#63](https://github.com/max-heller/mdbook-pandoc/pull/63))
- Link to hosted HTML version of book when relative links can't be resolved ([#66](https://github.com/max-heller/mdbook-pandoc/pull/66))
