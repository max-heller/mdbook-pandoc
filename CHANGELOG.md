...
- [**breaking**] Pass options to Pandoc as defaults file instead of command-line arguments ([#50](https://github.com/max-heller/mdbook-pandoc/pull/50))
...
- Update `git-cliff` config ([#52](https://github.com/max-heller/mdbook-pandoc/pull/52))
